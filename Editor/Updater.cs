...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.referencer";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/referencer/master/package.json";
    private const string CanUpdateKey = "Popcron.Referencer.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Referencer/Check for updates";
    private const string UpdateText = "Popcron/Referencer/Update";
